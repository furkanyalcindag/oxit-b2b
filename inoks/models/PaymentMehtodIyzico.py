...
class PaymentMethodIyzico(models.Model):
    ...
    apiKey = models.CharField(max_length=20, blank=True, null=True, verbose_name='API Anahtarı')
    secretKey = models.CharField(max_length=20, null=True, blank=True, verbose_name='Güvenlik Anahtarı')
