...
class PaymentMethodBakiyem(models.Model):
    ...
    password = models.CharField(max_length=20, null=True, blank=True, verbose_name="Şifre")
    dealerCode = models.CharField(max_length=20, null=True, blank=True, verbose_name="DealerCode")
