! function(e) {
    ...
    var t = {
        ...
        changePassToggle: function() {
            e("#sozlesme-checkbox").on("change", function() {
                e("#account-chage-pass").toggleClass("show")
            })
             e("#kampanya-checkbox2").on("change", function() {
                e("#account-chage-pass2").toggleClass("show")
            })
        },
        ...
        lightBox: function() {
            ...
            i.each(function() {
                ...
                var n;
                n = t.currentTarget.closest(".product-slider-container") ? (e(".product-single-carousel").data("owl.carousel").current() + i.length) % i.length : e(t.currentTarget).closest(".product-item").index(), e.magnificPopup.open({
                    items: o,
                        ...
                        callbacks: {
                            open: function() {
                                if (e(".sticky-header.fixed").css("margin-right") && !t.mobile) {
                                    var o = Number(e(".sticky-header.fixed").css("margin-right").slice(0, -2)) + 0+ "px";
        ...
        modalView: function() {
            e("body").on("click", ".btn-add-cart", function(o) {
                if (e(".add-cart-box #productImage").attr("src", e(this).parents(".product-default").find("figure img").attr("src")), e(".add-cart-box #productTitle").text(e(this).parents(".product-default").find(".product-title").text()), e(".sticky-header.fixed").css("margin-right") && !t.mobile) {
                    var i = Number(e(".sticky-header.fixed").css("margin-right").slice(0, -2)) + 0 + "px";
